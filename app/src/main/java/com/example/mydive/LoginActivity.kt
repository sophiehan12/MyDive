                ...
                UserApiClient.instance.me{ user, error->
                    if(error != null) {
                        ...
                        if(user.kakaoAccount?.email != null ){
                                ...
                                if(error!=null){
                                    ...
                                    UserApiClient.instance.me{ user, error->
                                        if(error != null){
                                            ...
                                            Log.i(TAG,"사용자 정보 요청 성공 :  ${user.kakaoAccount?.email.toString()}")
                                        }
                                    }
                                }
                            }
                            ...
                            Toast.makeText(applicationContext,"이메일 획득 뷸가", Toast.LENGTH_SHORT).show()
                        }
                        var intent = Intent(this@LoginActivity, MainActivity::class.java)
                        //var intent1 = Intent(this@LoginActivity, FragmentProfile::class.java)
